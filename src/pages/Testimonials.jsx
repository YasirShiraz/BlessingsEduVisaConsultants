    ...
    const testimonials = [
        {
            ...
            text: "Blessings EduVisa made my dream of studying in the UK a reality. Their team guided me through every step, from choosing the right course to the visa application. Highly recommended!",
            rating: 5
        },
        {
            name: 'Rajiv Sharma',
            ...
            text: "I was confused about the visa process for Canada, but the consultants here were incredibly patient and professional. They handled everything perfectly.",
            rating: 5
        },
        {
            name: 'Emily Chen',
            ...
            text: "The career counseling I received was a game-changer. They didn't just help me get in; they helped me choose a path I'm passionate about.",
            rating: 5
        },
        {
            name: 'Musa Khan',
            ...
            text: "Excellent service! The pre-departure briefing was very helpful and prepared me well for life in Australia. Transparent and honest advice.",
            rating: 5
        },
        {
            name: 'Ayesha Malik',
            ...
            text: "Efficient and reliable. They helped me find a great program and guided me through the complex German visa process with ease.",
            rating: 4
        }
    ];
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            ...
                            <div className="flex gap-1 text-gold mb-6">
                                {[...Array(testimonials[index].rating)].map((_, i) => <Star key={i} size={18} md:size={20} fill="currentColor" />)}
                            </div>
                            ...
                            <div className="flex flex-col items-center gap-3 md:gap-4">
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="text-gold font-bold uppercase tracking-widest text-[10px] md:text-sm mt-1">
                                        {testimonials[index].university}, {testimonials[index].country}
                                    </p>
                                </div>
                            </div>
                        </motion.div>
