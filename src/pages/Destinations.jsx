        ...
        >
            ...
            <section className="relative py-20 md:py-32 bg-navy text-white overflow-hidden">
                <div className="absolute inset-0 z-0">
                    <div className="absolute top-0 right-0 w-full h-full bg-[radial-gradient(circle_at_70%_50%,rgba(212,175,55,0.1),transparent)]"></div>
                    <div className="absolute -top-12 -left-12 w-64 md:w-96 h-64 md:h-96 bg-gold/10 rounded-full blur-[80px] md:blur-[100px]"></div>
                </div>
                ...
                <div className="container-custom relative z-10 px-4 md:px-6 text-center">
                    ...
                    >
                        Global <span className="text-gold">Study Hubs</span>
                    </motion.h1>
            ...
            {/* Custom CTA */}
            <section className="container-custom px-4 md:px-6 mb-20">
