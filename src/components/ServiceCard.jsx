...
const ServiceCard = ({ title, description, desc, icon: Icon }) => {
    ...
    return (
        ...
        >
            <div className="w-16 h-16 rounded-2xl bg-gray-50 flex items-center justify-center mb-8 text-navy group-hover:bg-gold group-hover:text-navy transition-all duration-300 shadow-sm border border-gray-50">
                {(() => {
            ...
            <h3 className="text-2xl font-bold mb-4 text-navy group-hover:text-gold transition-colors">{title}</h3>
