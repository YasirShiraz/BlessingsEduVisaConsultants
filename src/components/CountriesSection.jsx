            ...
            <div className="container-custom">
                ...
                <div className="flex flex-wrap justify-center gap-6 md:gap-10">
                    {countries.map((country) => (
                        <div key={country.id} className="group flex flex-col items-center gap-3 w-20 md:w-24">
                            ...
                            <span className="font-bold text-navy text-xs md:text-sm uppercase tracking-wide text-center group-hover:text-gold transition-colors">{country.name}</span>
                        </div>
                    ))}
                </div>
            </div>
